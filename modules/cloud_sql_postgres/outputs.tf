...
output "public_ip_address" {
  ...
  value       = google_sql_database_instance.postgres_instance.public_ip_address == "" ? null : google_sql_database_instance.postgres_instance.public_ip_address
}

output "private_ip_address" {
  description = "Represents the private IPv4 address assigned to the Cloud SQL instance."
  value       = google_sql_database_instance.postgres_instance.private_ip_address == "" ? null : google_sql_database_instance.postgres_instance.private_ip_address
